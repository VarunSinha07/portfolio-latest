...
### Contact Details
- **Email:** varunsinha2604@gmail.com
- **Phone:** +91 9341549993
- **GitHub:** [github.com/VarunSinha07](https://github.com/VarunSinha07)
- **LinkedIn:** [linkedin.com/in/varunsinha20](https://www.linkedin.com/in/varunsinha20/)
  ...
  "experience": [
    {
      ...
      "company": "SAARC MASTS TECH PVT LTD",
      "period": "June 2025 - Sept 2025",
      "location": "Remote",
      "impact": [
        "Built and optimized backend systems for mentor-student networking and progress tracking using Node.js and PostgreSQL, ensuring scalable performance and efficient data management.",
        "Engineered telemetry microservices and refactored bottleneck endpoints, cutting response latency by 35% and improving data throughput.",
        "Conducted code reviews and maintained high-quality, production-ready code following backend development best practices."
      ],
      "technologies": ["Node.js", "PostgreSQL", "Express", "Microservices", "Telemetry", "Git"]
    },
    {
      "role": "Full Stack Developer Intern",
      "company": "International Federation of Inventors' Association - Bharat Chapter",
      "period": "Dec 2024 - Mar 2025",
      "location": "Remote",
      "impact": [
        "Led end-to-end development and deployment of the IFIA Bharat web application, cutting page load time by 50% and improving responsiveness through SSR and automated CI/CD releases.",
        "Engineered scalable CI/CD pipelines and optimized custom DNS configurations to enable fast, reliable releases."
      ],
      "technologies": ["Next.js", "Tailwind CSS", "TypeScript", "Node.js", "Express", "PostgreSQL", "Vercel", "Docker"]
    }
  ]
}`,
  },
  ...
  const runScript = (scriptType: "download" | "open" | "test") => {
    ...
    if (scriptType === "download") {
      setTerminalLogs((prev) => [
        ...
        "[INFO] Resolving endpoint: public/varun-sinha-resume.pdf",
      ]);
      ...
      const interval = setInterval(() => {
        ...
        if (currentProgress >= 100) {
          ...
          setTimeout(() => {
            ...
            link.href = "/varun-sinha-resume.pdf";
            link.download = "varun-sinha-resume.pdf";
            link.click();
          }, 300);
        }
      }, 100);
      ...
      setTerminalLogs((prev) => [
        ...
        "",
        "$ npm run test:all",
        "> varun-portfolio@1.4.2 test:all",
        "> jest --verbose",
        "",
        ...
        <div className="workspace-window glass rounded-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden transition-all duration-300">
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-zinc-950/80 border-b border-white/10 select-none">
            ...
            <div className="text-xs font-mono text-zinc-500 flex items-center gap-1.5">
              ...
              <span>varun@workspace:~/resume</span>
            </div>
                  ...
                  {(Object.keys(FILES) as FileName[]).map((fName) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 w-full px-2.5 py-1.5 rounded-md font-mono text-xs text-left transition-all ${
                          isActive
                      ...
                      <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="p-5 rounded-xl border border-white/5 bg-zinc-950/40 hover:border-accent/30 transition-all duration-300 flex items-start gap-4">
                            <div className="p-3 rounded-lg bg-zinc-900 border border-white/5 text-accent shrink-0">
                              <GraduationCap className="h-6 w-6" />
                            </div>
                            <div className="space-y-1 flex-1">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
