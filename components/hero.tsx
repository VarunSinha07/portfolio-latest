...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[22%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none select-none z-0 hidden md:block">
        <h1
          ref={nameRef}
          className="font-sans text-[14vw] font-black uppercase tracking-tighter leading-none text-zinc-800/95"
        >
          {"Varun Sinha".split("").map((char, index) => (
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 items-end z-10">
        ...
        >
          ...
          <div className="space-y-2">
            <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-500">{"// DISCIPLINE"}</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-mono text-zinc-300 mt-1 leading-tight">
                B.Tech CSE BDA,<br />SRM Institute of Science and Technology
              </span>
            </div>
      ...
      <div className="hidden md:block absolute bottom-0 left-1/2 -translate-x-1/2 h-[650px] w-[510px] lg:h-[820px] lg:w-[600px] z-10">
        <div
