...
const JOURNEY_ITEMS = [
  ...
  },
  {
    ...
    description: "Engineered and optimized backend services for mentor–student networking and progress tracking using Node.js and PostgreSQL, ensuring scalable performance and efficient data management.",
  },
  {
    type: "experience",
    ...
    description: "Led the development and deployment of the IFIA Bharat web platform, improving page load performance by 50% while enhancing responsiveness, scalability, and overall user experience.",
  },
  {
    type: "achievement",
    role: "1st Runner Up",
    ...
    date: "Sept 2024",
    description: "Developed a full-stack event management platform with integrated payment processing, inventory tracking, and automated event operations for seamless user experiences.",
  },
];
