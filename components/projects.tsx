...
const projects: Project[] = [
  {
    ...
    href: "#",
    tags: ["Full Stack"],
    imgQuery: "biotech%20incubation%20dashboard%20ui",
  },
  {
    title: "Media Nexus",
    ...
    href: "#",
    tags: ["Full Stack"],
    imgQuery: "media%20management%20system%20ui",
  },
  {
    ...
    imgQuery: "college%20event%20management%20app%20ui",
  },
]
      ...
      <div className="mb-6 flex flex-wrap gap-2">
        {filters.map((f) => (
          <Button
            ...
            onClick={() => setActive(f)}
            className={active === f ? "neon text-color-white hover:text-black glass border border-border/60" : "glass border border-border/60"}
          >
            {f}
          </Button>
        ))}
            ...
            >
              ...
              <div className="p-5">
                <div className="flex flex-wrap items-center gap-2">
                  {p.tags.map((t) => (
                    <span key={t} className="text-2xs glass px-2 py-1 rounded-md border border-border/60">
                      {t}
                    </span>
                  ))}
                </div>
